...
const Tshowmore = () => {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.templeCon}>
        <View style={styles.imgContainer}>
          <View style={styles.img1}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Somnath-Temple.jpg',
              }}
              style={{
          ...
          <View style={styles.img1}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Kedarnath-Uttarakhand.jpg',
              }}
              style={{
                width: 120,
                height: 150,
          ...
          <View style={styles.img1}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Sanchi-Stupa.jpg',
              }}
              style={{
                width: 120,
                height: 150,
      ...
      {/* second block */}
      <View style={styles.templeCon2}>
        <View style={styles.imgContainer2}>
         
          <View style={styles.img2}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Vaishno-Devi-Mandir.jpg',
              }}
              style={{
                width: 120,
                height: 150,
          ...
          <View style={styles.img2}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Rameshwaram-Temple.jpg',
              }}
              style={{
                shadowColor: 'greenyellow',
                elevation: 55,
          ...
          <View style={styles.img2}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Siddhivinayak-Temple.jpg',
              }}
              style={{
                width: 120,
                height: 150,
      ...
      {/* 3rd block */}
      <View style={styles.templeCon3}>
        <View style={styles.imgContainer3}>
          <View style={styles.img3}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Gangotri-Temple-1.jpg',
              }}
              style={{
                shadowColor: 'greenyellow',
                elevation: 55,
          ...
          <View style={styles.img3}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Golden-Temple.jpg',
              }}
              style={{
                width: 120,
                height: 150,
          ...
          <View style={styles.img3}>
            <Image
              source={{
                uri: 'https://www.tourmyindia.com/blog//wp-content/uploads/2021/03/Kashi-Vishwanath-Temple.jpg',
              }}
              style={{
                width: 120,
                height: 150,
